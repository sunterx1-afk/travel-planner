...
| 메인 랜딩 페이지 (서비스 소개 / 이용방법) | AI 여행 일정 추천 및 카카오 맵 매핑 |
| :---: | :---: |
| <img src="./screenshots/main.png" width="100%"/> | <img src="./screenshots/planner.png" width="100%"/> |

| 지능형 AI 챗봇 컴포넌트 | 마이페이지 (내 일정 관리) |
| :---: | :---: |
| <img src="./screenshots/chatbot.png" width="100%"/> | <img src="./screenshots/mypage.png" width="100%"/> |

> *시연 스크린샷은 프로젝트 루트의 `screenshots` 폴더에 이미지를 넣은 후 경로를 맞춰주세요.*
...
- Java 17 이상
- Node.js & npm
- Oracle DB & Redis Server 실행 필요

### Backend Setup
```bash
cd backend
# application.properties 또는 yml에 DB, Redis, API Key 설정 후 실행
./mvnw spring-run